...
### Format général (par défaut) — chaque bloc sur une ligne séparée
...
2. **Ligne 2** : commence par « Antécédents : » puis la liste (points-virgules si plusieurs).
3. **Ligne 3** : commence par « Contexte : » avec les éléments utiles (traitements, situation...).
4. **Ligne 4** : commence par « Question(s) clinique(s) : » puis les questions regroupées sur une seule ligne, séparées par des « ? » ou des points.
